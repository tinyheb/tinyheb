...
# PosNr 020
#
WWWRUN	INSERT	Leistungsart	POSNR='020' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT) values (9999,'020','A','Vorgespräch',7.2,'Vorgespräch über Fragen der Schwangerschaft und Geburt,mindestens 30 Minuten, je angefangene 15 Minuten','2007-08-01','9999-12-31',15);
#
# PosNr 030
#
WWWRUN	INSERT	Leistungsart	POSNR='030' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1) values (9999,'030','A','Vorsorgeuntersuchung',22,'Vorsorgeuntersuchung der Schwangeren nach Maßgabe der Richtlinien des Gemeinsamen Bundesausschusses über die ärztliche Betreuung während der Schwangerschaft und nach der Entbindung in der jeweils geltenden Fassung','2007-08-01','9999-12-31',0,'+340');
#
# PosNr 040
#
WWWRUN	INSERT	Leistungsart	POSNR='040' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1) values (9999,'040','A','Entnahme von Körpermaterial',5.6,'Entnahme von Körpermaterial zur Durchführung notwendiger Laboruntersuchungen im Rahmen der Richtlinien des Gemeinsamen Bundesausschusses über die ärztliche Betreuung während der Schwangerschaft und nach der Entbindung (Mutterschafts-Richtlinien) in der jeweils geltenden Fassung, je Entnahme, einschließlich Veranlassung der Laboruntersuchung(en), Versand- und Portokosten, Dokumentation im Mutterpass nach den Mutterschafts-Richtlinien und Befundübermittlung','2007-08-01','9999-12-31',0,'');
#
# PosNr 050
#
WWWRUN	INSERT	Leistungsart	POSNR='050' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER) values (9999,'050','A','Hilfe bei Beschw.',14.4,'Hilfe bei Schwangerschaftsbeschwerden oder bei Wehen, für jede angefangenen 30 Minuten','2007-08-01','9999-12-31',30,'+350','051','051','051',180);
#
# PosNr 051
#
WWWRUN	INSERT	Leistungsart	POSNR='051' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER) values (9999,'051','A','Hilfe bei Beschw. Sa,So,Nacht',17.28,'Hilfe bei Schwangerschaftsbeschwerden oder bei Wehen, für jede angefangenen 30 Minuten, mit Zuschlag gemäß §5 Abs. 1','2007-08-01','9999-12-31',30,'+350','','','',180);
#
# PosNr 060
#
WWWRUN	INSERT	Leistungsart	POSNR='060' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER) values (9999,'060','A','CTG Überwachung',6.3,'Cardiotokografische Überwachnung bei Indikationen nach Maßgabe der Anlage 2 zu den Richtlinien des gemeinsamen Bundesausschusses über die ärztliche Betreuung während der Schwangerschaft und nach der Entbindung (Mutterschafts-Richtlinien) in der jeweils geltenden Fassung einschl. Dokumentation im Mutterpass nach den Mutterschafts-Richtlinien in der jeweils geltenden Fassung.','2007-08-01','9999-12-31',0,'','','','',0);
#
# Posnr 070
#
WWWRUN	INSERT	Leistungsart	POSNR='070' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER) values (9999,'070','A','Geburtsvorbereitung in der Gruppe',5.6,'Geburtsvorbereitung bei Unterweisung in der Gruppe, bis zu zehn Schwangere je Gruppe und höchsten 14 Stunden, für jede Schwangere je Unterrichtsstunden (60 Minuten)','2007-08-01','9999-12-31','E60','','','','',0);
#
# Posnr 080
WWWRUN	INSERT	Leistungsart	POSNR='080' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER,BEGRUENDUNGSPFLICHT) values (9999,'080','A','Einzelgeburtsvorbereitung',14.4,'Geburtsvorbereitung bei Einzelunterweisung auf ärztliche Anordnung höchstens 14 Unterrichtseinheiten a 30 Minuten, für jede angefangenen 30 Minuten','2007-08-01','9999-12-31','30','','','','',0,'J');
#
# -------------Geburtshilfe ---------------------
#
...
# PosNr 150
#
WWWRUN	INSERT	Leistungsart	POSNR='150' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER) values (9999,'150','B','Zuschlag Zwillinge',57.5,'Zuschlag für die Hilfe bei der Geburt von Zwillingen und mehr Kindern, für das zweite und jedes weitere Kind, je Kind','2007-08-01','9999-12-31','','','','','',0);
#
# PosNr 160
#
WWWRUN	INSERT	Leistungsart	POSNR='160' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER) values (9999,'160','B','Hilfe bei nicht vollendeter Geburt',140,'Hilfe bei einer nicht vollendeten Geburt a) im Krankenhaus, b) zu Hause, c) in einer außerklinischen Einrichtung unter Leitung einer Hebammen d) in einer außerklinischen Einrichtung unter ärztlicher Leitung','2007-08-01','9999-12-31',0,'+360','161','161','161',0);
#
# PosNr 161
#
WWWRUN	INSERT	Leistungsart	POSNR='161' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER) values (9999,'161','B','Hilfe bei nicht vollendeter Geburt Nacht,Sa,So',168,'Hilfe bei einer nicht vollendeten Geburt a) im Krankenhaus, b) zu Hause, c) in einer außerklinischen Einrichtung unter Leitung einer Hebammen d) in einer außerklinischen Einrichtung unter ärztlicher Leitung mit Zuschlag gemäß §5 Abs. 1','2007-08-01','9999-12-31',0,'+360','','','',0);
#
# PosNr. 170
WWWRUN	INSERT	Leistungsart	POSNR='170' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER) values (9999,'170','B','2. Hebamme',14.4,'Hilfe bei einer außerklinischen Geburt oder Fehlgeburt durch eine zweite Hebamme, für jede angefangene halbe Stunde','2007-08-01','9999-12-31','30','+360','171','171','171',0);
#
# PosNr. 171
#
WWWRUN	INSERT	Leistungsart	POSNR='171' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER) values (9999,'171','B','2. Hebamme Nacht,Sa,So',17.28,'Hilfe bei einer außerklinischen Geburt oder Fehlgeburt durch eine zweite Hebamme, für jede angefangene halbe Stunde mit Zuschlag gemäß §5 Abs. 1','2007-08-01','9999-12-31','30','+360','','','',0);
#
# ------------- Wochenbett ----------------------
#
...
# PosNr. 181
#
WWWRUN	INSERT	Leistungsart	POSNR='181' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER,EINMALIG) values (9999,'181','C','Hausbesuch Nacht,Sa,So',31.2,'Hausbesuch nach der Geburt mit Zuschlag gemäß §5 Abs. 1','2007-08-01','9999-12-31',0,'','','','',0,'+190');
#
# PosNr 190
#
WWWRUN	INSERT	Leistungsart	POSNR='190' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,ZUSATZGEBUEHREN2,ZUSATZGEBUEHREN3,ZUSATZGEBUEHREN4,SAMSTAG,SONNTAG,NACHT,DAUER,EINMALIG) values (9999,'190','C','Zuschlag 1. Besuch nach der Geburt',5.6,'Zuschlag zu der Gebühr nach Nr. 180 für den ersten Hausbesuch nach der Geburt','2007-08-01','9999-12-31','','+380','<6GK','+390','>5GK','','','',0,'');
#
# PosNr 200
#
WWWRUN	INSERT	Leistungsart	POSNR='200' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER,EINMALIG) values (9999,'200','C','Besuch in Krankenhaus oder außerkl. Einrichtung',12.9,'Besuch in einem Krankenhaus oder in einer außerklinischen Einrichtung unter ärztlicher Leitung','2007-08-01','9999-12-31',0,'','201','201','201',0,'');
#
# PosNr 201
#
WWWRUN	INSERT	Leistungsart	POSNR='201' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT,ZUSATZGEBUEHREN1,SAMSTAG,SONNTAG,NACHT,DAUER,EINMALIG) values (9999,'201','C','Besuch in K-Haus oder außerkl. Einr. Nacht,Sa,So',15.48,'Besuch in einem Krankenhaus oder in einer außerklinischen Einrichtung unter ärztlicher Leitung mit Zuschlag gemäß §5 Abs. 1','2007-08-01','9999-12-31',0,'','','','',0,'');
#
# PosNr. 210
#
...
# PosNr. 390
#
WWWRUN	INSERT	Leistungsart	POSNR='390' and GUELT_VON='2007-08-01' and GUELT_BIS='9999-12-31'	insert into Leistungsart (ID,POSNR,LEISTUNGSTYP,KBEZ,EINZELPREIS,BEZEICHNUNG,GUELT_VON,GUELT_BIS,FUERZEIT) values (9999,'390','M','Pauschale Wochenbettbetreuung nach 4 Tag p.p.',13.3,'Materialpauschale bei Beginn der Betreuung später als vier Tage nach der Geburt','2007-08-01','9999-12-31',0);
#
# PosNr. 400
#
